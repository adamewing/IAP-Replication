...
wget http://hgdownload.cse.ucsc.edu/goldenPath/mm9/encodeDCC/wgEncodeMapability/wgEncodeCrgMapabilityAlign50mer.bigWig 
...
grep -v '^#' wgEncodeCrgMapabilityAlign50mer.wig > wgEncodeCrgMapabilityAlign50mer.bed
